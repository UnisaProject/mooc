		...
		if(users !=null && users.size() > 0) {
			...
			for(ImportedUser user: users) {
				try {
                    ...
                    TempUser tempUser = new TempUser(user.getEid(),
                                    user.getEmail(), null, null, user.getEid(),
                                    user.getPassword(), user.getAge(),
                                    user.getLocation(), user.getGender(), null);
                    /* end of unisa-change */
                    ...
                    User newUser = UserDirectoryService.addUser(null,
                                    user.getEid(), user.getFirstName(),
                                    user.getLastName(), user.getEmail(),
                                    user.getPassword(), user.getType(), user.getAge(),
